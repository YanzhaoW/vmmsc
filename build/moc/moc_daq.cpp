...
#include "../../../dg_epool/SRS/vmm_daq/include/daq.h"
...
struct qt_meta_stringdata_DAQ_t {
    QByteArrayData data[1];
    char stringdata0[4];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DAQ_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DAQ_t qt_meta_stringdata_DAQ = {
    {
QT_MOC_LITERAL(0, 0, 3) // "DAQ"
...
const QMetaObject DAQ::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DAQ.data,
      qt_meta_data_DAQ,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DAQ::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DAQ.stringdata0))
