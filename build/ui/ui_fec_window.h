...
public:
    ...
    void setupUi(QWidget *fec_window)
    {
        ...
        gridLayout_3->addWidget(onACQ_3, 10, 1, 1, 1);
        ...
        gridLayout_3->addWidget(trgPulser_3, 10, 0, 1, 1);
        ...
        gridLayout_3->addWidget(trgExternal_3, 11, 0, 1, 1);

        fec_WarmInit = new QPushButton(groupBox_12);
        fec_WarmInit->setObjectName(QStringLiteral("fec_WarmInit"));
        fec_WarmInit->setEnabled(true);
        fec_WarmInit->setFont(font);

        gridLayout_3->addWidget(fec_WarmInit, 13, 0, 1, 2);
        ...
        gridLayout_3->addWidget(offACQ_3, 11, 1, 1, 1);
        ...
        gridLayout_3->addWidget(holdOffCheckBox_3, 4, 0, 1, 2);
        ...
        gridLayout_3->addWidget(acqWindow_3, 7, 0, 1, 1);
        ...
        setTrgAcqConst_3->setFont(font3);

        gridLayout_3->addWidget(setTrgAcqConst_3, 7, 1, 1, 1);
        ...
        setEvbld = new QPushButton(groupBox_4);
        setEvbld->setObjectName(QStringLiteral("setEvbld"));
        setEvbld->setFont(font2);

        gridLayout_5->addWidget(setEvbld, 4, 0, 1, 1);
        ...
        debugScreen->setGeometry(QRect(0, 50, 131, 131));
        ...
        gridLayout->addWidget(groupBox_19, 4, 0, 1, 2);
    ...
    void retranslateUi(QWidget *fec_window)
    {
        ...
        setEvbld->setText(QApplication::translate("fec_window", "Set", 0));
