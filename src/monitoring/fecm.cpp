...
bool FecM::loadFec(const boost::property_tree::ptree::value_type pt)
{
    bool ok = true;
    ...
    try {
        ...
        cout << "FecM::loadFec    ERROR creating FECM" << endl;
        ok = false;
    }
        ...
        try {
            BOOST_FOREACH(ptree::value_type v, pt.second) {
                ...
                ////////////////////////////////////////////
                    ...
                    cout << "FecM::loadFec   WARNING Unknown key: " << v.first << endl;
                    ok = false;
                }
            } // foreach
        } //try
        catch(std::exception &e) {
            cout << "FecM::loadFec    ERROR: " << e.what() << endl;
            ok = false;
        }
    }//ok
...
{
    cout << "-----------------------------------" << endl;
    cout << "  Print FECM " << endl;
    cout << "      dcs file    : " << m_dcs_file << endl;
    cout << "      name        : " << m_name << endl;
    cout << "      IP          : " << m_ip << endl;
    cout << "      ID          : " << m_id << endl;
    cout << " - - - - - - - - - - - - - - - - - " << endl;
    cout << "  FECM Printing loaded chip array " << endl;
    for(int ichip = 0; ichip < m_chipArraySize; ichip++){
        m_chipArray[ichip]->print();
    }
}
